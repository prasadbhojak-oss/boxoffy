...
function WeekendPreviewHero() {
  ...
  const pSupergirl = useTMDBPoster("Supergirl", "2026");
  const tiles = [ { src:pWTTJ, ab:"WJ" }, { src:pMaaInti, ab:"MB" }, { src:pMVA, ab:"VA" }, { src:pSupergirl, ab:"SG" } ];
  const [hover, setHover] = React.useState(false);
  return (
    <a href="/weekend-recap-june-26-28-2026.html" style={{ textDecoration:"none", display:"block" }}>
      <div
      ...
      >
        ...
        <div style={{ flex:1, minWidth:0, display:"flex", flexDirection:"column", justifyContent:"center" }}>
          <span style={{ alignSelf:"flex-start", background:"#16A34A", color:"#FFFFFF", fontFamily:"'Barlow Condensed', sans-serif", fontWeight:900, fontSize:9, letterSpacing:"0.12em", padding:"2px 7px", borderRadius:2, marginBottom:7 }}>WEEKEND RECAP · JUN 26–28</span>
          <div style={{ fontFamily:"'Barlow Condensed', sans-serif", fontWeight:900, fontSize:"clamp(15px, 1.7vw, 17px)", color:"#FFFFFF", lineHeight:1.15, letterSpacing:"-0.01em" }}>
            Akshay Rules the Weekend · A Sleeper Keeps Climbing
          </div>
          <div style={{ fontFamily:"'DM Sans', sans-serif", fontSize:10.5, color:"#9CA3AF", marginTop:5, lineHeight:1.4 }}>
            We nailed Welcome to the Jungle&apos;s Day 1 to the rupee — plus the sleeper that won&apos;t stop climbing, and the full India &amp; US Top 10
          </div>
