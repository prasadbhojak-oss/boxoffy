        ...
        {!isMobile && <>
          ...
          <div style={{ marginLeft:"auto", display:"flex", alignItems:"center", gap:12, flexShrink:0 }}>
            ...
            <div style={{ display:"flex", flexDirection:"column", alignItems:"flex-end" }}>
              <span style={{ fontFamily:"'Barlow Condensed', sans-serif", fontWeight:700, fontSize:13, color:"#374151", letterSpacing:"0.03em" }}>Wed, 25 Mar 2026 · D7 ~₹45 Cr ⚡</span>
      ...
      {isMobile && menuOpen && (
        <div style={{
          ...
          <div style={{ padding:"10px 20px", background:"#F9FAFB", borderTop:"1px solid #F3F4F6" }}>
            <span style={{ fontFamily:"'DM Sans', sans-serif", fontSize:12, color:"#9CA3AF" }}>Wed, 25 Mar 2026 · D7 ~₹45 Cr ⚡</span>
          </div>
        </div>
      )}
    </div>
...
function BoxOfficeSection({ onNavigate, forceAllTime, onClearForceAllTime }) {
  ...
  const bmsStats = [
    ...
    { label:"7-Day India Nett ✅",    val:"₹620.67 Cr",    src:"Sacnilk/Republic/The Week confirmed" },
    { label:"7-Day WW Gross",         val:"~₹980 Cr",      src:"Sacnilk confirmed · Overseas ₹231.57 Cr" },
          ...
          >
            ...
            <div style={{ flex:1, minWidth:260 }}>
              ...
              <div style={{
                ...
                <span style={{ color:T.accent }}>₹563 Cr in 6 Days. Week 1 Targeting ₹620+ Cr. WW ~₹980 Cr.</span>
              </div>
            ...
            <div style={{ display:"flex", gap:0, borderLeft:`1px solid ${T.border}`, flexShrink:0 }}>
              {[
                ...
                { label:"7-Day India Nett ✅", val:"₹620.67 Cr", sub:"D0-D6 confirmed · Sacnilk/Republic/The Week" },
              ].map((s,i) => (
                <div key={i} style={{
              ...
              >
                ...
                <div style={{ borderTop:`5px solid ${T.accent}`, padding:"28px 36px 22px", borderBottom:`1px solid ${T.border}`, position:"relative" }}>
                  ...
                  <h1 style={{
                    ...
                    <span style={{ color:"#22C55E" }}>₹620.67 Cr D0–D7 · D7 ~₹50 Cr ⚡ · Ram Navami D8 · WW ~₹980 Cr.</span>
                  </h1>
                ...
                <div style={{ padding:"28px 36px", display:"flex", flexDirection:"column", gap:28 }}>
                  ...
                  <div>
                    ...
                    <div style={{ display:"grid", gridTemplateColumns:"repeat(auto-fill, minmax(170px, 1fr))", gap:8 }}>
                      {[
                        ...
                        { label:"D6 Tuesday ✅",           val:"₹56.55 Cr",    sub:"Sacnilk/Republic confirmed · D0-D6 ₹620.67 Cr nett" },
                  ...
                  <div style={{ background:T.surfaceAlt, border:`1px solid ${T.border}`, borderRadius:3, padding:"20px 24px" }}>
                    ...
                    <p style={{ fontFamily:"'DM Sans', sans-serif", fontSize:14, color:T.textMid, lineHeight:1.8, margin:0 }}>
                      Dhurandhar: The Revenge has shattered every record in Hindi cinema. ₹102.55 Cr Day 1. ₹113 Cr Eid Saturday. ₹102 Cr Sunday. Three days above ₹100 Cr nett — no Hindi film has ever done that. D0–D7 total ₹620.67 Cr India nett. ~₹980 Cr worldwide. $13.5M in North America — Indian cinema's all-time NA 4-day record. A generational opening.
                    </p>
                  </div>
      ...
      <div style={{
        ...
        <div>
          ...
          <p style={{ fontFamily:"'DM Sans', sans-serif", fontSize:13, color:T.textMuted, marginLeft:12 }}>
            {showWeekly ? "Week 13, 2026 — D0–D7 ₹620.67 Cr nett · WW ~₹980 Cr · D7 ~₹50 Cr ⚡ · Ram Navami D8 · Week 1 target ₹620+ Cr" : "Top Indian films by worldwide gross · Industry tracking data"}
          </p>
        </div>
        {topFilm && (
      ...
      {year === 2026 && (
        <div style={{ borderBottom:`1px solid ${T.border}`, background:T.surfaceAlt }}>
          <div style={{ display:"flex", alignItems:"center", gap:12, padding:"8px 24px", flexWrap:"wrap" }}>
            ...
            <span style={{ fontFamily:"'DM Sans', sans-serif", fontSize:11, color:T.textMuted }}>
              Week 13 · Mar 25, 2026 · D0–D7 ₹620.67 Cr nett · WW ~₹980 Cr · D7 ~₹50 Cr ⚡ Boxoffy call · Ram Navami D8 🚀
            </span>
            <span style={{ background:"#FEF3C7", border:"1px solid #FCD34D", fontFamily:"'DM Sans', sans-serif", fontSize:10, color:"#92400E", fontWeight:700, padding:"2px 8px", borderRadius:2 }}>
              ✅ D0–D7 CONFIRMED ₹620.67 Cr · D7 Wed ~₹50 Cr ⚡ · Ram Navami D8 Thu holiday · WW ~₹980 Cr · Week 1 projection ₹620+ Cr
            </span>
            ...
            <span style={{ marginLeft:"auto", fontFamily:"'DM Sans', sans-serif", fontSize:10, color:T.textMuted, fontStyle:"italic" }}>
              Boxoffy Intelligence · Week 13, 2026 · Updated Mar 24 · D0–D7 ₹620.67 Cr
            </span>
          </div>
        </div>
      )}
      ...
      >
        <div style={{
          ...
          <div style={{
            ...
            Dhurandhar: The Revenge —{" "}
            <span style={{ color:T.accent }}>₹620.67 Cr in 6 Days. Week 1 Above ₹600 Cr. WW ~₹980 Cr.</span>
          </div>
